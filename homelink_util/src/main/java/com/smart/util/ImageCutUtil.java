...
public class ImageCutUtil {
     ...
     * @throws IOException
     */
    public static boolean saveImageToDisk(byte[] data,String imageName) throws IOException{
        int len = data.length;
        String photoPathFile = "";
        // 写入到文件
    ...
    public static byte[] decode(String imageData) throws IOException{
        byte[] data = Base64.decode(imageData.getBytes());
