...
public class JPush369 {
    ...
    private static final String appKey = "6619f780246795e06ee0dd21";    //必填，app所产生的唯一键
    private static final String masterSecret = "ae4e20c0c6643229502cf00a";//必填，每个应用都对应一个masterSecret
