package com.smart.util.weixin.encryption;
...
public class Sample {
	...
	public static void main(String[] args) throws Exception {
		String sToken = "PBgR22CsFRbxWxhzMPYcnvd3B8u";
		String sCorpID = "wxe71007977c76156f";
		String sEncodingAESKey = "8wxFsxAXfAEC9Psd8rjfpRhTcfVWynjKR9TForbXtIp";
