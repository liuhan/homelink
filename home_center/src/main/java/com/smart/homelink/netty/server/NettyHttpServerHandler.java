...
public class NettyHttpServerHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        String returnCode = RetMsgType.SUCCESS.getCode();
        String returData = "";
        if(msg instanceof FullHttpRequest) {
            ...
            //进行返回404
            returnCode = RetMsgType.IM_HTTP_REQUEST_ERROR.getCode();
        }
...
//        }
    ...
    public  String   sendData(Map<String, String> paramMap) throws Exception{
        ...
        if(Utility.isNullorEmpty(nettyMessage.getData())) return  RetMsgType.SIGN_ERROR.getCode();
        ...
        if(!NettyUtil.validateSign(nettyMessage)){
            logger.error("签名错误 terminalNo:{}，data:{}" , nettyMessage.getCode(), nettyMessage.getData() );
             return   RetMsgType.SIGN_ERROR.getCode();
        }
        ...
        if (channel == null) {
            ...
            return  RetMsgType.IM_HTTP_REQUEST_OFF_LINE.getCode();
        }
        ...
        return   RetMsgType.SUCCESS.getCode();
    }
