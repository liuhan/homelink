...
public class BankCardBinUtil {
    ...
    private static final String[] bankName = { "广东发展银行.广发理财通", "农业银行.金穗借记卡",
            ...
            "上海浦东发展银行.东方卡", "深圳发展银行.发展卡", "招商银行","建设银行","中信银行",};

    public static String getNameOfBank(String charBin) {
        int bin = 0, index = 0;
        charBin=charBin.substring(0,6);
