 ...
 */
public class MyRedisRegistry extends FailbackRegistry {

    private static final Logger logger = LoggerFactory.getLogger(MyRedisRegistry.class);
    ...
    public MyRedisRegistry(URL url) {
        super(url);
        if (url.isAnyHost()) {
    ...
    private class Notifier extends Thread {
        ...
        private boolean isSkip() {
            ...
            if (connectSkiped.getAndIncrement() < skip) { // 妫�鏌ヨ烦杩囨鏁�
                return true;
            }
