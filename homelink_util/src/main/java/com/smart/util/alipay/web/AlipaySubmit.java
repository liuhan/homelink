package com.smart.util.alipay.web;

import com.smart.util.spring.CustomizedPropertyConfigurer;
...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        if(AlipayConfig.sign_type.equals("MD5") ) {
            ...
            String alipay_key = CustomizedPropertyConfigurer.getContextProperty("alipay_key");
	...
	public static String query_timestamp() throws MalformedURLException,
        ...
        String alipay_partner = CustomizedPropertyConfigurer.getContextProperty("alipay_partner");
       // String strUrl = ALIPAY_GATEWAY_NEW + "service=query_timestamp&partner=" + AlipayConfig.partner + "&_input_charset" +AlipayConfig.input_charset;
        String strUrl = ALIPAY_GATEWAY_NEW + "service=query_timestamp&partner=" + alipay_partner + "&_input_charset" +AlipayConfig.input_charset;
