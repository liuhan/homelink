...
public class TransformationUtil {
    ...
    private static TransformationUtil formatter = null;
    ...
    public static TransformationUtil getInstance() {
        if (formatter == null)
            formatter = new TransformationUtil();
        return formatter;
    }
    ...
    public String convertToChineseNumber(String moneyStr) {
        String result;
        ...
        while (cMoneyStringBuffer.indexOf("零佰") != -1) cMoneyStringBuffer.replace(cMoneyStringBuffer.indexOf("零佰"),
    ...
    public static void main(String args[]) {
        System.out.println(getInstance().format(new Double(0.25)));
    }
}
